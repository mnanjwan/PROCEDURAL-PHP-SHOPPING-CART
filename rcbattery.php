...
<!-- Mirrored from demo.hasthemes.com/pustok-preview/pustok/shop-grid-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Dec 2019 12:43:34 GMT -->
<head>
	<meta charset="utf-8" />
								...
								<div class="product-card">
									<div class="product-grid-content">
										<div class="product-header">
											...
											<h3><a href="product-details.php">RC HELI AIR BATTERY</a></h3>
										</div>
						...
						<div class="inner-page-sidebar">
							...
							<div class="single-block">
								...
								<ul class="sidebar-menu--shop">
									<li class="cat-item"><a href="rcbattery.php">RC Car Battery (9)</a></li>
                                        <li class="cat-item"><a href="hbattery.php">RC Heli & Airplane Battery (2)</a></li>
                                        <li class="cat-item"><a href="uavbattery.php">UAV Battery (9)</a></li>
                                        <li class="cat-item"><a href="airbattery.php">Airsoft GunBattery (17)</a></li>
								</ul>
							</div>
							<!-- Price -->
